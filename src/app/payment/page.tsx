  ...
  return (
    <main>
      ...
      <div className={styles.bg}>
        ...
        <p className={styles.order_conf_text} onClick={() => btn_handler("order_details")}>Total: {5.05} EUR</p>
